...
// startAddExpense - TEST CASE with firebase
...
test("should add expense DEFAULT values to database and store DEFAULT values", (done) => {
  const store = createMockStore({});
...
// EDIT_EXPENSE
test("should set expense action obejct with data", () => {
